...
QString CmdsTab_cad::symbolTag(const QString& symbol)
{
    ...
    //result += "/home/t2l/Development/KADLUB/cvz/evo/cad_exe/resource/";
...
//=============================================================================
int CmdsTab_cad::tab_set_cad(TcCmdContext* /*context*/, TcArgCol& /*args*/)
{
    QString result;

    //result.append("<div class=toolbar>");

    //result.append("<div class='cmdblock'><b>file: </b>");
    //result.append("<a href='tcview:://#cmd_cad_save'>[save]</a>");
    //result.append("<a href='tcview:://#cmd_cad_active_file_move'>[move]</a>");
    //result.append("<a href='tcview:://#cmd_cad_list_files'>[list files]</a>");
    //result.append("<a href='tcview:://#cmd_cad_file_open G:/HOME/KADLUB/cvz/samples/cad/test.t2l show'>[open test]</a>");
    //result.append("</div>");

    //result.append("<div class='cmdblock'>");
    //result.append("<b>view:</b> ");
    //result.append(QString() + "<a href='tcview:://#view_new'>"                   + symbolTag("view_new")         + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_view_pan'>"               + symbolTag("view_pan")         + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_view_zoomrect'>"          + symbolTag("view_zoomrect")    + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_cad_view_fit'>"           + symbolTag("view_fit")         + "</a>");
    //result.append("&nbsp;&nbsp;&nbsp;");

    //result.append("<b>info:</b> ");
    //result.append(QString() + "<a href='tcview:://#cmd_cad_measure'>"            + symbolTag("info_measure")     + "</a>");
    //result.append("&nbsp;&nbsp;&nbsp;");

    //result.append("<b>create:</b> ");
    //result.append(QString() + "<a href='tcview:://#cmd_cad_draw_line'>"          + symbolTag("create_line")      + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_enter'>"           + symbolTag("create_symbol")    + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_cad_draw_image'>"         + symbolTag("create_image")     + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_cad_draw_text'>"          + symbolTag("create_text")      + "</a>");
    //result.append("&nbsp;&nbsp;&nbsp;");

    //result.append(" <b>copy:</b> ");
    //result.append(QString() + "<a href='tcview:://#cmd_object_mocopy_parallel'>" + symbolTag("copy_parallel")    + "</a>");
    //result.append("&nbsp;&nbsp;&nbsp;");

    //result.append("<b>edit:</b> ");
    //result.append(QString() + "<a href='tcview:://#cmd_object_move'>"            + symbolTag("edit_move")        + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_movepoints'>"      + symbolTag("edit_move_points") + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_trim'>"            + symbolTag("edit_trim")        + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_trimtoother'>"     + symbolTag("edit_trimto")      + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_set_symbology'>"   + symbolTag("edit_symbology")   + "</a>");
    //result.append(QString() + "<a href='tcview:://#cmd_object_delete'>"          + symbolTag("delete")           + "</a>");
    //result.append("</div>");

    /*result.append("<div class='cmdblock'>");
    result.append("<b>test:</b> test ");
    result.append("<a href='tcview:://#test_new_drawing'>[new drawing]</a>");
    result.append("<a href='tcview:://#test_text_drawing'>[text drawing]</a>");
    result.append("<a href='tcview:://#display_objecst'>[display objects]</a>");
    result.append("<a href='tcview:://#objects_expand'>[expand]</a>");
    result.append("<a href='tcview:://#objects_fence'>[fence]</a>");
    result.append("<a href='tcview:://#view_new red'>[view red]</a>");
    result.append("<a href='tcview:://#view_new green'>[green]</a>");
    result.append("<a href='tcview:://#view_new blue'>[blue]</a>");
    result.append("&nbsp;&nbsp;&nbsp;");


    result.append("<b>photomap:</b> ");
    result.append("<a href='tcview:://#viewinfo'>[viewinfo]</a>");
    result.append("<a href='tcview:://#cmd_real_measure_enter'>[real MEASURE]</a>");
    result.append("<a href='tcview:://#cmd_ref_file_enter'>[enter file ref]</a>");
    result.append("<a href='tcview:://#cmd_ref_file_navigate e'> [navigate ref]</a>");
    result.append("<a href='tcview:://#cmd_over_file_manipulate'> [over file EXPAND]</a>");
    result.append("<a href='tcview:://#cmd_refed_file_navigate'> [REFED list]</a>");
    result.append("</div>");
    ...
    //====================================================================================
    //result.append("<br><hr>");
    /*result.append("<div class='active_command'>");
        result.append("<div><b>");
    ...
    QString dialog = CmdQueue::queue().activeCommand()->dialog();
    if (dialog.isEmpty() == false) {
        result.append("<div>");
    ...
    TcHtmlViewTabbed::mainView().tabSet("cad", result.toLatin1().data());
    return 0;
}
